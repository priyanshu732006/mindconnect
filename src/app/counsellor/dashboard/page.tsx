...
export default function CounsellorDashboardPage() {
    const isExternal = true; // This would come from user data
        ...
        <div className="space-y-8">
            <header className="flex justify-between items-center">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <span className="font-semibold text-sm rounded-full px-3 py-1 bg-secondary text-secondary-foreground">
                        {isExternal ? 'External Counsellor' : 'On-Campus Counsellor'}
                    </span>
                </div>
            </header>
